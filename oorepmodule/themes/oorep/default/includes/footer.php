...
?>
		...
		-->    
		<a href="<?php echo getenv('OOREP_APPLICATION_HOST'); ?>/">Back to main page</a>
                &nbsp; | &nbsp;
		<a href="<?php echo getenv('OOREP_APPLICATION_HOST'); ?>/forgot_password">Help, I forgot my password!</a>
